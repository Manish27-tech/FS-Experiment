...
const initialState = { platforms: ['All', 'Dev.to', 'Medium', 'Hashnode', 'FreeCodeCamp'], activePlatform: 'All' };
const platformsSlice = createSlice({
  name: 'platforms', initialState,
  reducers: { setActivePlatform: (state, action) => { state.activePlatform = action.payload; } },
});
